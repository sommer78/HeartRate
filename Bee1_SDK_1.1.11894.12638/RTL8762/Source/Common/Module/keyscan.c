...
void KeyPad_Init()//KEYSCAN_CONFIG_STRUCT * Keyscan_Param)
{
    ...
    keyScanInitStruct.colSize         = 4;
    keyScanInitStruct.rowSize         = 4;

    keyScanInitStruct.detectPeriod    = KeyScan_Detect_Period_10ms;
    keyScanInitStruct.debounceEn      = KeyScan_Debounce_Enable;
    keyScanInitStruct.timeout         = KeyScan_Timeout_2s;
    keyScanInitStruct.scanInterval    = KeyScan_Scan_Interval_100ms;

    keyScanInitStruct.debounceTime    = (16 * 32); //8ms
