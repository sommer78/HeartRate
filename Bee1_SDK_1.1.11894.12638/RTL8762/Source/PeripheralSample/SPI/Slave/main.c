...
{
    Pinmux_Config(SPI0_SCK, SPI0_CLK_0_Slave);
	Pinmux_Config(SPI0_MOSI, SPI0_SI_0_Slave);//SPI0_MO_Master <--> SPI0_SI_0_Slave
	Pinmux_Config(SPI0_MISO, SPI0_SO_0_Slave);//SPI0_MI_Master <--> SPI0_SO_0_Slave
