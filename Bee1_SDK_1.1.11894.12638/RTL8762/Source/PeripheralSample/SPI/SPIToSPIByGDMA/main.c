...
**********************************************************************************************************
* @file		main.c
* @brief	This file provides demo code of SPI0 read data from W25Q64 flash and SPI1 send data by GDMA.
* @details
* @author	elliot chen
* @date 	2015-08-19
* @version	v1.0
...
#define SPI1_SCK				P3_0		 
#define SPI1_MOSI				P2_5
#define SPI1_MISO				P3_2		 
#define SPI1_CS				    P2_4
...
void SPI_PADConfiguration(void)
{
	...
	Pad_Config(SPI1_SCK, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP, PAD_OUT_DISABLE, PAD_OUT_HIGH);
	Pad_Config(SPI1_MOSI, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP, PAD_OUT_DISABLE, PAD_OUT_HIGH);
	Pad_Config(SPI1_MISO, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP, PAD_OUT_DISABLE, PAD_OUT_HIGH);
	Pad_Config(SPI1_CS, PAD_PINMUX_MODE, PAD_IS_PWRON, PAD_PULL_UP, PAD_OUT_DISABLE, PAD_OUT_HIGH);
}
...
void GDMA_RXConfiguration(void)    
{
    ...
    SPI1_InitStructure.SPI_Direction   = SPI_Direction_TxOnly;
    ...
    SPI1_InitStructure.SPI_ClockSpeed  = 8000000;
    SPI1_InitStructure.SPI_FrameFormat = SPI_Frame_Motorola;
	...
	GDMA_InitStruct.GDMA_TransferType        = GDMA_TransferType_SPI0_RX | GDMA_TransferType_SPI1_TX;
	GDMA_InitStruct.GDMA_ChannelPriority     = 5;
	...
	//SPI_SendBuffer(SPI0, GDMA_WriteCmdBuffer, 4);
