...
**********************************************************************************************************
* @file		main.c
* @brief	This file provides demo code of SPI read data from GD25Q32 by GDMA and send to data uart.
* @details
* @author	elliot chen
* @date 	2015-08-20
* @version	v1.0
...
{
	/* turn on GDMA SPI and data uart clock */
...
{
    Pinmux_Config(UART_TX, DATA_UART_TX);
    Pinmux_Config(UART_RX, DATA_UART_RX);
}
...
void GDMA_RXConfiguration(void)    
{
    ...
    uint8_t GDMA_RevflashBuffer[256];
    ...
    SPI_InitStructure.SPI_CPOL        = SPI_CPOL_High;
    SPI_InitStructure.SPI_CPHA        = SPI_CPHA_2Edge;
    SPI_InitStructure.SPI_ClockSpeed  = 100000;
    SPI_InitStructure.SPI_FrameFormat = SPI_Frame_Motorola;
	SPI_InitStructure.SPI_NDF 		  = 99;
	...
	GDMA_InitStruct.GDMA_TransferType        = GDMA_TransferType_SPI0_RX | GDMA_TransferType_UART0_TX;
