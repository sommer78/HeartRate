...
#define queueQUEUE_TYPE_Timer               ( ( uint8_t ) 6U )
...
#define xQueueCreateTimer( uxQueueLength, uxItemSize ) xQueueGenericCreate( uxQueueLength, uxItemSize, queueQUEUE_TYPE_Timer )
/**
 * queue. h
 * <pre>
