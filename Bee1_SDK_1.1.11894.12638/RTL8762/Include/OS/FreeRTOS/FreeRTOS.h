...
#define pvPortMallocAligned( x, ramType, puxStackBuffer ) ( ( ( puxStackBuffer ) == NULL ) ? ( pvPortMalloc( ( x ), ramType ) ) : ( puxStackBuffer ) )
#endif

#ifndef vPortFreeAligned
#define vPortFreeAligned( pvBlockToFree, ramType ) vPortFree( pvBlockToFree, ramType )
#endif
