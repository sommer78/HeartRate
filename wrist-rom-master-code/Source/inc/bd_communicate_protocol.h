...
typedef enum {
    ...
    GET_STACK_DUMP          = 0x10,
    /*
      INCOMMING_CALL_CMD_ID = 10,
      ANSWER_CALL_CMD_ID = 11,
      REJECT_CALL_CMD_ID = 12,
      INCOMMING_SMS_CMD_ID = 13,
      CALENDAR_REMIND_CMD_ID = 14,
      
      REQUEST_DATA_COMMAND_ID = 20,
      RETURN_DATA_COMMAND_ID = 21,
    */
