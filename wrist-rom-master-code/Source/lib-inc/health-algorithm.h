...
typedef struct algorithm_event_click {
  int click_count;
} algorithm_event_click_t;
...
*/
int init_health_algorithm(int sample_rate, float hight_cm, float weight_kg, float age, char isfemale);
...
char * health_algorithm_get_error_desc(void);
#endif
